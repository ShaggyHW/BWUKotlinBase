...
class SWHDebugScript(name: String, scriptConfig: ScriptConfig, scriptDefinition: ScriptDefinition): LoopingScript(name, scriptConfig, scriptDefinition) {
	...
	override fun initialize(): Boolean {
		...
		this.sgc = SHWDebugScriptGraphicsContext(this, console)
		return true
	}
